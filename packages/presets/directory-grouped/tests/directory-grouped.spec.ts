...
describe('directory-grouped preset', () => {
  ...
  const testDocuments = [
    {
      location: 'src/module-a/graphql/me-query.graphql',
      document: operationAst,
    },
    {
      location: 'src/module-a/graphql/user-fragment.graphql',
      document: fragmentAst,
    },
    {
      location: 'src/module-b/graphql/me.query.graphql',
      document: operationAst,
    },
    {
      location: 'src/module-b/graphql/something-query.graphql',
      document: operationAst,
    },
    {
      location: 'src/module-c/graphql/nested/somethingElse.graphql',
      document: operationAst,
    },
    {
      location: 'src/module-c/graphql/nested/from-js.js',
      document: operationAst,
    },
    {
      location: 'src/module-c/graphql/component.ts',
      document: operationAst,
    },
  ];
  ...
  it.only('Should build the correct operation files paths', async () => {
    const result = await preset.buildGeneratesSection({
      baseOutputDir: './src/',
      config: {},
      presetConfig: {
    ...
    expect(result.map(a => a.filename)).toEqual([
      'src/module-a/types.generated.ts',
      'src/module-b/types.generated.ts',
      'src/module-c/types.generated.ts',
    ]);
  });
